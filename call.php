...
<head>
    ...
    <script src="src/tinySIP/src/tsip_api.js?svn=7" type="text/javascript"> </script>
    <!-- Styles -->
...
<script type="text/javascript">
    ...
    //    window.location.href += (window.location.href.indexOf("?") == -1 ? "?svn=7" : "&svn=7"); 
    //}
    ...
    function postInit() {
        ...
        if (tsk_utils_have_webrtc4all()) {
            tsk_utils_log_info("WebRTC type = " + WebRtc4all_GetType());
            if (tsk_utils_webrtc4all_get_version() != "1.9.731") {
...
<body style="cursor:wait">
        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        <li class="active"><a href="index.htm?svn=7">Home</a></li>
                    </ul>
                </div>
                <!--/.nav-collapse -->
            </div>
    ...
    <div class="container">
        ...
        <footer>
            <p>&copy; Doubango Telecom 2012</p>
